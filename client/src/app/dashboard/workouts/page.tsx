...
import { ArrowUpRight, Clock3, Dumbbell, Plus, Sparkles, Trash2 } from 'lucide-react';
...
import { useCreateWorkout, useExercises, useProfile, useWorkouts } from '@/lib/hooks/useApi';
    ...
    <section className="animate-fade-in space-y-5">
      <header className="app-surface overflow-hidden p-5 md:p-7">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-[11px] uppercase tracking-widest text-primary">Workout plans</p>
            <h1 className="mt-1.5 text-3xl font-black tracking-tight text-white">Choose your training protocol</h1>
            <p className="mt-2 text-sm text-soft">Use prebuilt workouts or create your own from your exercise library.</p>
            ...
            <DialogContent className="max-w-4xl p-0" showCloseButton>
              <div className="max-h-[85vh] overflow-y-auto p-5 md:p-6">
                ...
                <div className="mt-5 space-y-4">
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-soft">Workout Description</label>
                    <textarea
                      value={description}
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-soft">Workout Image URL (optional)</label>
                    <input
                      value={imageUrl}
                  ...
                  <div className="space-y-1 md:w-64">
                    <label className="text-xs font-semibold text-soft">Workout Level</label>
                    <select
                      value={level}
        ...
        {workoutsList.map((workout) => (
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2 text-xs">
              ...
              <span className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 ${workout.isGlobal ? 'bg-primary/15 text-primary' : 'bg-surface-3 text-soft'}`}>
                <Sparkles className="h-3 w-3" />
                {workout.isGlobal ? 'Prebuilt' : 'My Workout'}
              </span>
            </div>
